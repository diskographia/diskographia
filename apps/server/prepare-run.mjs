...
const from = 'D:/diskographia/сурсы';
const to = 'D:/diskographia/apps/client/public/decor';
const fonts = 'D:/diskographia/apps/client/public/fonts';
...
async function main() {
  ...
  await copyFile(join(from, 'BDTerminal-VF-Regular.woff2'), join(fonts, 'bd-terminal.woff2'));
  await copyFile(join(from, 'OCR55__C.woff2'), join(fonts, 'ocr-onec.woff2'));
  console.log('шрифты');
}
